...
#~ Backround = np.loadtxt(os.path.join(args.inputDir, 'Micropattern', 'Micropattern.dat'))
...
# ~ ax2.contour(Backround, extent=[0,LengthX,0,LengthY],levels = [0.3], colors = 'mediumslateblue', linewidths = (3))
